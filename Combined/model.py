""""
This section deals with the training and inference of the combined data
"""
...
# Load all files
train_inputs = np.load('comb_train_inputs.npy')
train_outputs = np.load('comb_train_outputs.npy')
val_inputs = np.load('comb_valid_inputs.npy')
val_outputs = np.load('comb_valid_outputs.npy')
test_inputs = np.load('comb_test_inputs.npy')
test_outputs = np.load('comb_test_outputs.npy')
